 ...
 * Source : https://developers.google.com/gmail/api/SendEmail.java
 */
...
public class SendEmail {
    ...
    public static Message sendMessage(Gmail service,
                                      String userId,
                                      MimeMessage emailContent, SendMailActivity activity) {
        ...
        try {
            ...
            activity.startActivityForResult(
                    e.getIntent(), activity.REQUEST_AUTHORIZATION);
            e.printStackTrace();
